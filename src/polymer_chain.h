...
public:
   ...
   * The data format is as follows:
       ...
       10 bonds # total number of bonds, for bead system, it equals to number of
        *beads - 1
   ...
   # bead_id, chain_id, bead_type, x, y, z, rot_x, rot_y, rot_z, f_x, f_y, f_z,
   #Q
   */
   ...
   * !n_beads_perChain ---> number of beads per chain (all chains have the same
   *number of beads)
   * !LS ---> the maximum bond length
   * !init_bbox_min   ---> min of the box you want to generate your initial
   *polymers in.
   * !init_bbox_max   ---> mat of the box you wnat to generate your initial
   *polymers in.
   * !filename	    ---> where you want to output the polymer data you
   *generated.
   */
